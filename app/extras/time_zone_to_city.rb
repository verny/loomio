...
#    result = []
#    a = city_list.map do |city| 
#      begin
#        r = ActiveSupport::TimeZone[city].formatted_offset
#      rescue
#        next
#      end
#      [r, city]
#    end
#    a.flatten
    a = city_list.map { |city| [ActiveSupport::TimeZone[city].nil? ? '' :ActiveSupport::TimeZone[city].formatted_offset, city] }.flatten
